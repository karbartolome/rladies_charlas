...
En este caso, los datos contienen información sobre resultados educativos, Stock and Watson (2007). Incluyen características sociodemográficas de estudiantes y escuelas en distritos de California. 
...
equatiomatic::extract_eq(reg_lineal, 
                         greek_colors     = c('black','violet','black'), 
                         subscript_colors = c('black','violet', 'black'))
```
...
CASchools %>% 
  ...
  stat_smooth(method='lm', color='violet', se=FALSE, fullrange=TRUE)+
  labs(
...
2. Renderizar parametrizados que incluyen código R y python
...
[Comparación entre R y python para ciencia de datos](https://www.youtube.com/watch?v=dQw4w9WgXcQ)
