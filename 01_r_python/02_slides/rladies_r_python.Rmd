...
Pero también hay recursos pagos si se busca mayor capacidad de cómputo / almacenamiento.
...
👉 [Archivo .Rmd para ejecutar python en rmarkdown desde un conda environment](https://github.com/karbartolome/rladies_charlas/blob/main/01_r_python/03_condaenvs/03_conda_envs.Rmd)
...
```{r check_supuestos, fig.height=5, fig.width=10, echo=FALSE, eval=TRUE}
